...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        ...
        <div class="ui large labeled input"><input type="text" value="User" placeholder="Nickname" maxlength="14" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
...
let scripturl = "https://github.com/Sweezy88/gartic.io-bot/raw/main/script/Gartic%20bot%20control.user.js";
...
setInterval(function() {  if(spam == true){ 
  ...
  item.contentWindow.postMessage({'command': 'spam', 'spam': spam, 'spamid': spamid,  'text': "❄️SPAM BY SWEEZY❄️"}, '*')
); s_id = 1;} } 
}, 3000);
